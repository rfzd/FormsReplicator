...
class Container extends Nette\Forms\Container
{
	...
	public static function register($methodName = 'addDynamic')
	{
		...
		Nette\Utils\ObjectMixin::setExtensionMethod(Nette\Forms\Container::class, $methodName, function (Nette\Forms\Container $_this, $name, $factory, $createDefault = 0, $forceDefault = FALSE, $containerClass = NULL) {
